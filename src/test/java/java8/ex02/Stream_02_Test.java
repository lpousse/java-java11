...
public class Stream_02_Test {
	...
	public void test_mapToDouble_sum() throws Exception {
		 ...
		 * commandes)
		 */
		double result = orders.stream().map(o -> o.getPrice()).reduce(0.0, (p1, p2) -> p1 + p2);
	...
	public void test_mapToDouble_avg() throws Exception {
		 ...
		 */
		//OptionalDouble result = orders.stream().collect(Collectors.averagingDouble(o -> o.getPrice()));
